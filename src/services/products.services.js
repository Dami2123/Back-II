...
export class ProductsService {
    ...
    static async addProduct(product) {
        try {
            ...
            return await products.getProductByFilter({ code: product.code })
        }
        catch (error) {
    ...
    static async updateProduct(id, updatedFields) {
        ...
        try {
            const productUpdated = await products.updateProduct(id, updatedFields);
            return await products.getProductByFilter({ _id: productUpdated._id })
        } catch (error) {
